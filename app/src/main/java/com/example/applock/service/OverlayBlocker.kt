...
object OverlayBlocker {
    ...
    fun show(context: Context) {
        ...
        try {
            ...
            val view = FrameLayout(context.applicationContext).apply {
            ...
            Log.e("OverlayBlocker", "Failed to add overlay view: ${e.message}")
            overlayView = null
        }
    }
    ...
    fun hide() {
        try {
            ...
            Log.e("OverlayBlocker", "Failed to remove overlay view: ${e.message}")
        } finally {
            overlayView = null
        }
    }
